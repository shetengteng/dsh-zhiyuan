...
import { buildImportInput, importFiles } from './import.ts'
import type { ImportResult } from '../../model/types.ts'
...
export async function importDroppedBytes(dataRoot: string, input: {
  baseId: string
  destCategory: string
  fileName: string
  bytes: Buffer
