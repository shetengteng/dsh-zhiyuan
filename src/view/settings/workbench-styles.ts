...
.zy-btn,.zy-ghost,.zy-icon,.zy-tab,.zy-del,.zy-kb-select,.zy-selector,.zy-box,.zy-area{appearance:none}
...
.zy-kb-description{margin:0 10px 4px;background:var(--dsw-alias-bg-module-platform);border-radius:10px;font-size:12px;line-height:18px;flex:none}
.zy-kb-description>summary{cursor:pointer;list-style:none;padding:6px 10px;color:var(--dsw-alias-label-secondary);display:flex;align-items:baseline;min-width:0}
.zy-kb-summary{flex:0 1 auto;min-width:0;overflow:hidden;white-space:nowrap}
