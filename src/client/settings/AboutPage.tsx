...
export function AboutPage() {
  return (
    <div className="zy-about">
      <h3>这是什么</h3>
      <p>知源是 DSH 的本地优先知识库。它把你指定的 md/txt/UTF-8 csv 导入本机文件夹。提问时一次只查一个库。导入不会自动建库，也不会把文件默默塞进某个库。</p>
      ...
      <ol>
        ...
        <li>开始导入。内容相同的文件会跳过，不会覆盖。目前支持 md/txt 和 UTF-8 csv；CSV 可在预览弹框中表格编辑。</li>
      </ol>
