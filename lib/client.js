...
function LibPage(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "zy-lib", children: [
    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "zy-list", children: [
      props.bases.map((base2) => /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: `zy-row${current?.id === base2.id ? " is-on" : ""}`, children: [
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("button", { className: "zy-base", type: "button", onClick: () => props.onSelect(base2.id), children: base2.title || base2.id }),
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("button", { className: "zy-del", type: "button", "aria-label": `\u5220\u9664 ${base2.title}`, onClick: () => props.onDeleteBase(base2), children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(TrashIcon, {}) })
      ] }, base2.id)),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "zy-cab", children: current ? /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Door, { lead, rest, aliases: current.aliases, path: `bases/${current.id}/` }),
...
function doorParts(description) {
  ...
  if (cut2 === -1 || cut2 >= text.length - 1) return { lead: text.replace(/。$/, ""), rest: "" };
  return { lead: text.slice(0, cut2), rest: text.slice(cut2 + 1).trim() };
}
function Door(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("details", { className: "zy-door", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "zy-door-body", children: [
      props.rest || null,
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "zy-help", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("code", { children: props.path }) }),
...
function TreeItem(props) {
  const del2 = /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("button", { className: "zy-del", type: "button", "aria-label": `\u5220\u9664 ${props.node.name}`, onClick: () => props.onDelete(props.node.path, props.node.kind), children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(TrashIcon, {}) });
...
function MdToolbar(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "zy-md-bar", role: "toolbar", children: [
    /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(Tb, { label: "B", title: "\u52A0\u7C97", active: editor.isActive("bold"), onClick: () => editor.chain().focus().toggleBold().run() }),
    /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(Tb, { label: "I", title: "\u659C\u4F53", active: editor.isActive("italic"), onClick: () => editor.chain().focus().toggleItalic().run() }),
    /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(Tb, { label: "S", title: "\u5220\u9664\u7EBF", active: editor.isActive("strike"), onClick: () => editor.chain().focus().toggleStrike().run() }),
    /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { className: "zy-md-sep" }),
    /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(Tb, { label: "H1", title: "\u4E00\u7EA7\u6807\u9898", active: editor.isActive("heading", { level: 1 }), onClick: () => editor.chain().focus().toggleHeading({ level: 1 }).run() }),
    /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(Tb, { label: "H2", title: "\u4E8C\u7EA7\u6807\u9898", active: editor.isActive("heading", { level: 2 }), onClick: () => editor.chain().focus().toggleHeading({ level: 2 }).run() }),
    /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(Tb, { label: "H3", title: "\u4E09\u7EA7\u6807\u9898", active: editor.isActive("heading", { level: 3 }), onClick: () => editor.chain().focus().toggleHeading({ level: 3 }).run() }),
    /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { className: "zy-md-sep" }),
    /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(Tb, { label: "\u2022", title: "\u65E0\u5E8F\u5217\u8868", active: editor.isActive("bulletList"), onClick: () => editor.chain().focus().toggleBulletList().run() }),
    /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(Tb, { label: "1.", title: "\u6709\u5E8F\u5217\u8868", active: editor.isActive("orderedList"), onClick: () => editor.chain().focus().toggleOrderedList().run() }),
    /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(Tb, { label: "\u201C", title: "\u5F15\u7528", active: editor.isActive("blockquote"), onClick: () => editor.chain().focus().toggleBlockquote().run() }),
    /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(Tb, { label: "</>", title: "\u4EE3\u7801\u5757", active: editor.isActive("codeBlock"), onClick: () => editor.chain().focus().toggleCodeBlock().run() })
  ] });
}
function Tb(props) {
...
function hitSnippet(text, startLine, endLine) {
  ...
  const last = Math.min(endLine && endLine >= first2 ? endLine : first2, lines.length);
  return lines.slice(first2 - 1, last).join("\n").trim();
}
function scrollToSnippet(root, snippet) {
...
function SearchDialog(props) {
  return /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(import_dsh_client_ui_primitives3.Modal, { open: true, onClose: props.onClose, title: `\u641C\u7D22  ${props.baseId}`, className: "zy-modal-form", children: [
    ...
    props.hits.length ? /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { className: "zy-search-hits", children: props.hits.map((hit) => /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("button", { className: "zy-hit-line", type: "button", onClick: () => props.onOpen(hit), children: [
      hit.path,
      ":",
      hit.startLine,
      " ",
...
function HitMark(props) {
  const q2 = props.query.trim();
  const i = q2 ? props.text.toLowerCase().indexOf(q2.toLowerCase()) : -1;
  if (i < 0) return /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(import_jsx_runtime8.Fragment, { children: props.text });
  return /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(import_jsx_runtime8.Fragment, { children: [
    props.text.slice(0, i),
    /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("mark", { children: props.text.slice(i, i + q2.length) }),
    props.text.slice(i + q2.length)
  ] });
}
function PreviewDialog(props) {
  ...
  const range = props.startLine && props.startLine > 0 ? ` \xB7 ${props.startLine}${props.endLine && props.endLine !== props.startLine ? `\u2013${props.endLine}` : ""} \u884C` : "";
  return /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(
    import_dsh_client_ui_primitives3.Modal,
    {
      ...
      children: [
        props.readonly ? /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(MdEditor, { text: props.text, readonly: true, startLine: props.startLine, endLine: props.endLine }, props.path) : /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(
          "form",
          {
            ref: form,
            onSubmit: (event) => {
            ...
            children: /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(MdEditor, { ref: editorRef, text: props.text, readonly: false }, props.path)
          }
        ),
        /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(Note, { text: props.error })
      ]
...
function PrefsPage(props) {
  ...
  const current = props.bases.find((base2) => base2.id === draft.defaultBaseId);
...
.zy-door>summary{cursor:pointer;list-style:none;padding:6px 10px;color:var(--dsw-alias-label-secondary);display:flex;align-items:center;gap:6px;min-width:0}
  ...
  return function ZhiyuanSettings() {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { className: "zy", children: [
      /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { className: "zy-head", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("div", { className: "zy-tabs", role: "tablist", children: ["lib", "prefs", "about"].map((id) => /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(
          "button",
          {
            type: "button",
            role: "tab",
      ...
      /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { className: tab === "lib" ? "zy-body" : "zy-body is-doc", children: [
        tab === "lib" ? /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(
          LibPage,
          {
            bases,
            current,
            ...
            onDeleteEntry: (path, kind) => {
              setConfirm({
                ...
                run: () => run3(() => call({ op: "deleteEntry", id: currentId, path, confirm: true }).then(() => void 0))
              });
              setDialog("confirm");
            }
          }
      ...
      dialog === "edit" && current ? /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(
        EditDialog,
        {
          base: current,
          error,
          ...
          onDelete: () => {
            setConfirm({ message: `\u5220\u9664\u77E5\u8BC6\u5E93\u300C${current.title}\u300D\u53CA\u5176\u4E2D\u6587\u4EF6\uFF1F`, run: () => run3(() => call({ op: "deleteBase", id: current.id, confirm: true }).then(() => void 0)) });
            setDialog("confirm");
          },
          onSubmit: (input) => void run3(() => call({ op: "update", id: current.id, ...input, aliases: aliases(input.aliases) }).then(() => void 0))
        }
      ) : null,
      dialog === "import" && current ? /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(
        ImportDialog,
        {
          baseId: current.id,
          error,
          ...
          onSubmit: (input) => void run3(() => call({ op: "ingest", ...input, baseId: current.id }).then(() => void 0))
        }
      ) : null,
      dialog === "search" && current ? /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(
        SearchDialog,
        {
          baseId: current.id,
          query,
      ...
      dialog === "preview" ? /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(
        PreviewDialog,
        {
          ...
          onSave: (text) => void run3(() => call({ op: "write", id: currentId, path: preview.path, text }).then(() => void 0)),
          onDelete: () => {
            setConfirm({
              message: `\u5220\u9664\u6587\u4EF6\u300C${preview.path}\u300D\uFF1F`,
              run: () => run3(() => call({ op: "deleteEntry", id: currentId, path: preview.path, confirm: true }).then(() => void 0))
            });
            setDialog("confirm");
          }
        }
...
function KbSearchView(props) {
  ...
  if (failed) return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("div", { className: "zy-note", children: firstText(block?.content) || "\u68C0\u7D22\u5931\u8D25" });
  if (!hits.length) return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("div", { className: "zy-help", children: "\u65E0\u547D\u4E2D" });
  return /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { children: [
    hits.map((hit) => /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("button", { className: "zy-hit", type: "button", onClick: () => setOpen(hit), children: [
    ...
    open ? /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
      import_dsh_client_ui_primitives6.Modal,
      {
        ...
        className: "zy-modal-wide",
        footer: /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("button", { className: "zy-btn", type: "button", onClick: () => setOpen(null), children: "\u5173\u95ED" }),
        children: /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("pre", { className: "zy-pre", children: open.excerpt })
      }
    ) : null
  ] });
}
