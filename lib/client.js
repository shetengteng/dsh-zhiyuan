...
function SearchDialog(props) {
  return /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(import_dsh_client_ui_primitives3.Modal, { open: true, onClose: props.onClose, title: `\u641C\u7D22  ${props.baseId}`, className: "zy-modal-form", children: [
    ...
    props.hits.length ? /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { className: "zy-search-hits", children: props.hits.map((hit) => /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("button", { className: "zy-hit-line", type: "button", onClick: () => props.onOpenHit(hit), children: [
      ...
      hit.startLine,
      " ",
      /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(HitMark, { text: hit.excerpt.split("\n").find((line) => line.trim()) ?? "", query: props.query })
...
function PreviewDialog(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(
    import_dsh_client_ui_primitives3.Modal,
    {
      ...
      children: [
        props.readonly ? /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(MdEditor, { text: props.text, readonly: true, startLine: props.startLine, endLine: props.endLine }, props.entryPath) : /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(
          "form",
          {
            ref: form,
            onSubmit: (event) => {
...
function createSettingsSection(remote, sessions, workspaces) {
  return function ZhiyuanSettings() {
    ...
    const [preview, setPreview] = (0, import_react5.useState)({ entryPath: "", text: "", readonly: false, startLine: 0, endLine: 0 });
...
function KbSearchView(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { children: [
    hits.map((hit) => /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("button", { className: "zy-hit", type: "button", onClick: () => setSelectedHit(hit), children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("div", { className: "zy-quote", children: hit.excerpt.split("\n").find((line) => line.trim()) ?? hit.excerpt })
    ...
    selectedHit ? /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
      import_dsh_client_ui_primitives6.Modal,
      {
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("pre", { className: "zy-pre", children: selectedHit.excerpt })
      }
    ) : null
  ] });
}
